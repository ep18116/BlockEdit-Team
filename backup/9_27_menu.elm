port module Main_menu exposing (..)
...
subscriptions model = receiveMsg MsgGet
...
update msg model = 
    case msg of
        ...
        MsgBrickMake ast event -> 
            ( brickMake ast event model |> startDnD event , Cmd.none )
